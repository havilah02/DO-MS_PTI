init <- function() {
  ...
  type <- 'plot'
  box_title <- 'Mean reporter ion intensity for all channels but carrier'
  help_text <- 'Plotting the mean reporter ion intensity for all channels but the carrier.  Carrier channel determined as channel with max median intensity. '
